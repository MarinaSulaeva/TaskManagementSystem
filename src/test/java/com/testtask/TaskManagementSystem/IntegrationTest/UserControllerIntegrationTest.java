...
public class UserControllerIntegrationTest {
    ...
    private void addToDb() {
        ...
        Users user = usersRepository.save(new Users(1,
                ...
                Role.USER));
        Users userExecutor = usersRepository.save(new Users(2,
                "user1@gamil.com",
                "$2a$10$DIbqqLodN24iFcXG2YNqvOyz4LcBKhFPF9viA3RzDea09YBHCBlse",
                Role.USER));
        Task task = new Task(1, "task", "task description", Status.CREATED, Priority.HIGH, user, userExecutor);
        taskRepository.save(task);
        commentRepository.save(new Comment(1, usersRepository.findByUsername("user@gmail.com").orElseThrow(), task, LocalDateTime.now(), "comment text"));
    }
